    ...
    <div className=" flex flex-col m-auto  max-w-screen-xl bg-new-blue lg:bg-white">
      <div className=" relative  w-full h-xs md:h-mid  m-auto ">
        ...
        <img
          src={left}
          alt="left"
          className="absolute left-0 w-5/12 bottom-0  transform -translate-x-1/3 sm:translate-x-0 "
        />
      ...
      <div className="relative flex flex-col items-center justify-center h-lg bg-new-blue px-8 mt-8 xl:px-14 ">
        <h1 className=" mb-8 text-blue-900 text-2xl md:text-4xl text-center font-semibold   sm:w-735">
        ...
        <div className=" text-blue-900 sm:w-735">
          <div className="relative bg-white px-8 py-4">
            ...
            <div className="flex flex-col sm:flex-row sm items-center justify-center  my-6">
        ...
        <div className="flex flex-col items-center justify-center sm:my-4">
